...
int CreateRooFit_ttbar()
{
  ...
  std::cout<<"bTagSF   - - 1.1402"<<std::endl;
  ...
  if (doHistograms)
  {
    ...
    h_mX_SR_ttbar->Draw("hist"); h_mX_SR_ttbar->SetMaximum(h_mX_SR_ttbar->GetMaximum()*2.5); h_mX_SR_ttbar->GetXaxis()->SetRangeUser(200, 1200);
  ...
  if (doFit)
  {
    ...
    leg->AddEntry(h_mX_SR_ttbar_upTrigCSV, "Trig SF (CSV) +1 #sigma");
    leg->AddEntry(h_mX_SR_ttbar_downTrigCSV, "Trig SF (CSV) -1 #sigma");
    leg->AddEntry(h_mX_SR_ttbar_upTrigpT, "Trig SF (pT) +1 #sigma");
    leg->AddEntry(h_mX_SR_ttbar_downTrigpT, "Trig SF (pT) -1 #sigma");
    leg->Draw();
    ...
    double ttbar_p0_errSyst_min=par.sg_p0-(*std::min_element(ttbar_p0_errSyst, ttbar_p0_errSyst+9));
    double ttbar_p0_errSyst_max=(*std::max_element(ttbar_p0_errSyst, ttbar_p0_errSyst+9))-par.sg_p0;
    ...
    double ttbar_p1_errSyst_min=par.sg_p1-(*std::min_element(ttbar_p1_errSyst, ttbar_p1_errSyst+9));
    double ttbar_p1_errSyst_max=(*std::max_element(ttbar_p1_errSyst, ttbar_p1_errSyst+9))-par.sg_p1;
    ...
    double ttbar_p2_errSyst_min=par.sg_p2-(*std::min_element(ttbar_p2_errSyst, ttbar_p2_errSyst+9));
    double ttbar_p2_errSyst_max=(*std::max_element(ttbar_p2_errSyst, ttbar_p2_errSyst+9))-par.sg_p2;
