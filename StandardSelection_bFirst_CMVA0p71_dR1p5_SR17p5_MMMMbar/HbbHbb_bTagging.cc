...
int helper_TrigBin_CSV(double csv)
{
  int i=-1;
  if (csv<0.3) i=1;
  else if (csv<0.65) i=2;
  else if (csv<0.9) i=3;
  else if (csv<0.95) i=4;
  else if (csv>=0.95) i=5;
  return i;
}
*/
...
int helper_TrigBin_CSV(double csv)
{
  ...
  else if (csv<0.85) i=3;
  else if (csv<0.95) i=4;
  else if (csv>=0.95) i=5;
  return i;
}

int helper_TrigBin_pT2(double pT)
{
  int i=-1;
  if (pT<40) i=1;
  else if (pT<60) i=2;
...
int helper_TrigBin_pT4(double pT)
{
  int i=-1;
  if (pT<30) i=1;
  else if (pT<40) i=2;
                    ...
                    int bJetRegression=0)
{
  ...
  std::string inputfilename="../OfficialStep2_KinematicallySelected_"+sample+".root";
  TChain *tree=new TChain("tree");
  tree->Add(inputfilename.c_str());
  std::cout<<"Opened input file "<<inputfilename<<std::endl;
  
  TFile *file_triggerSF_CSV=new TFile("/Users/souvik/HbbHbb/Analysis/TriggerEfficiencies/CMVA/ratio_2DCMVA.root");
  ...
  TH1F *h_H1Jet1pT=new TH1F("h_H1Jet1pT", "h_H1Jet1pT", 50, 0., 500.);
  TH1F *h_H1Jet2pT=new TH1F("h_H1Jet2pT", "h_H1Jet2pT", 50, 0., 300.);
  ...
  TH2F *h_RecoGenpT_pT_1_b=new TH2F("h_RecoGenpT_pT_1_b", "(Reco pT - Gen pT) / GenpT ~ Jet 1; Reco pT (GeV); (Reco pT - Gen pT) / GenpT", 50, 0., 500., 50, -1., 1.);
  TH2F *h_RecoGenpT_pT_2_b=new TH2F("h_RecoGenpT_pT_2_b", "(Reco pT - Gen pT) / GenpT ~ Jet 2; Reco pT (GeV); (Reco pT - Gen pT) / GenpT", 50, 0., 500., 50, -1., 1.);
  TH2F *h_RecoGenpT_pT_3_b=new TH2F("h_RecoGenpT_pT_3_b", "(Reco pT - Gen pT) / GenpT ~ Jet 3; Reco pT (GeV); (Reco pT - Gen pT) / GenpT", 50, 0., 500., 50, -1., 1.);
  TH2F *h_RecoGenpT_pT_4_b=new TH2F("h_RecoGenpT_pT_4_b", "(Reco pT - Gen pT) / GenpT ~ Jet 4; Reco pT (GeV); (Reco pT - Gen pT) / GenpT", 50, 0., 500., 50, -1., 1.);
  
  TH2F *h_RegGenpT_pT_1_b=new TH2F("h_RegGenpT_pT_1_b", "(Reg pT - Gen pT) / GenpT ~ Jet 1; Reco pT (GeV); (Reg pT - Gen pT) / GenpT", 50, 0., 500., 50, -1., 1.);
  TH2F *h_RegGenpT_pT_2_b=new TH2F("h_RegGenpT_pT_2_b", "(Reg pT - Gen pT) / GenpT ~ Jet 2; Reco pT (GeV); (Reg pT - Gen pT) / GenpT", 50, 0., 500., 50, -1., 1.);
  TH2F *h_RegGenpT_pT_3_b=new TH2F("h_RegGenpT_pT_3_b", "(Reg pT - Gen pT) / GenpT ~ Jet 3; Reco pT (GeV); (Reg pT - Gen pT) / GenpT", 50, 0., 500., 50, -1., 1.);
  TH2F *h_RegGenpT_pT_4_b=new TH2F("h_RegGenpT_pT_4_b", "(Reg pT - Gen pT) / GenpT ~ Jet 4; Reco pT (GeV); (Reg pT - Gen pT) / GenpT", 50, 0., 500., 50, -1., 1.);
  
  TH2F *h_RegmGenpT_pT_1_b=new TH2F("h_RegmGenpT_pT_1_b", "(Reg pT - Gen pT)~ Jet 1; Reco pT (GeV)", 50, 0., 500., 20, -200., 200.);
  TH2F *h_RegmGenpT_pT_2_b=new TH2F("h_RegmGenpT_pT_2_b", "(Reg pT - Gen pT)~ Jet 2; Reco pT (GeV)", 50, 0., 500., 20, -200., 200.);
  TH2F *h_RegmGenpT_pT_3_b=new TH2F("h_RegmGenpT_pT_3_b", "(Reg pT - Gen pT)~ Jet 3; Reco pT (GeV)", 50, 0., 500., 20, -200., 200.);
  TH2F *h_RegmGenpT_pT_4_b=new TH2F("h_RegmGenpT_pT_4_b", "(Reg pT - Gen pT)~ Jet 4; Reco pT (GeV)", 50, 0., 500., 20, -200., 200.);
  ...
  TH1F *h_trig_afterTag_den=new TH1F("h_trig_afterTag_den", "h_trig_afterTag_den", 30, 0., 30.);
  TH1F *h_trig_afterTag_num=new TH1F("h_trig_afterTag_num", "h_trig_afterTag_num", 30, 0., 30.);
  ...
  for (int i=0; i<nEvents; ++i)
  {
    ...
    for (int j=0; j<naJets; ++j)
    {
      ...
      // if (jetpT[j+nhJets]/aJetpT[j]!=1.) std::cout<<"WHAT! jetpT[j+nhJets]/aJetpT[j] = "<<jetpT[j+nhJets]/aJetpT[j]<<std::endl;
    ...
    // std::cout<<"(HCSVhi, HCSVlo) = ("<<HCSVhi<<", "<<HCSVlo<<") = ("<<helper_TrigBin_CSV(HCSVhi)<<", "<<helper_TrigBin_CSV(HCSVlo)<<") = "<<triggerWeight_CSV<<" +/- "<<triggerWeight_CSV_error<<std::endl;
      ...
      // if (jetCSV[H1jet2_i]>jetCSV_cut) 
      {
        ...
        // if (jetCSV[H2jet1_i]>jetCSV_cut) 
        {
          ...
          // if (jetCSV[H2jet2_i]>jetCSV_cut) 
          {
            ...
            h_H1Jet1pT->Fill((jet1_p4.Pt()+jet3_p4.Pt())/2., weightPU);
            h_H1Jet2pT->Fill((jet2_p4.Pt()+jet4_p4.Pt())/2., weightPU);
          }
        }
      }
    }
    ...
    if (jetCSV[H1jet1_i]<=bTagCSV_mediumCut) {++nTagsMbar;}
    if (jetCSV[H1jet2_i]<=bTagCSV_mediumCut) {++nTagsMbar;}
    if (jetCSV[H2jet1_i]<=bTagCSV_mediumCut) {++nTagsMbar;}
    if (jetCSV[H2jet2_i]<=bTagCSV_mediumCut) {++nTagsMbar;}
    
    int nTags0p6=0;
    if (jetCSV[H1jet1_i]>0.6) {++nTags0p6;}
    if (jetCSV[H1jet2_i]>0.6) {++nTags0p6;}
    if (jetCSV[H2jet1_i]>0.6) {++nTags0p6;}
    if (jetCSV[H2jet2_i]>0.6) {++nTags0p6;}
    
    int nTags0p5=0;
    if (jetCSV[H1jet1_i]>0.5) {++nTags0p5;}
    if (jetCSV[H1jet2_i]>0.5) {++nTags0p5;}
    if (jetCSV[H2jet1_i]>0.5) {++nTags0p5;}
    if (jetCSV[H2jet2_i]>0.5) {++nTags0p5;}
    
    int nTags0p4=0;
    if (jetCSV[H1jet1_i]>0.4) {++nTags0p4;}
    if (jetCSV[H1jet2_i]>0.4) {++nTags0p4;}
    if (jetCSV[H2jet1_i]>0.4) {++nTags0p4;}
    if (jetCSV[H2jet2_i]>0.4) {++nTags0p4;}
    
    int nTags0p3=0;
    if (jetCSV[H1jet1_i]>0.3) {++nTags0p3;}
    if (jetCSV[H1jet2_i]>0.3) {++nTags0p3;}
    if (jetCSV[H2jet1_i]>0.3) {++nTags0p3;}
    if (jetCSV[H2jet2_i]>0.3) {++nTags0p3;}
    
    int nTags0p2=0;
    if (jetCSV[H1jet1_i]>0.2) {++nTags0p2;}
    if (jetCSV[H1jet2_i]>0.2) {++nTags0p2;}
    if (jetCSV[H2jet1_i]>0.2) {++nTags0p2;}
    if (jetCSV[H2jet2_i]>0.2) {++nTags0p2;}
    
    h_nTags->Fill(nTagsM, weightPU);
    
    // std::cout<<"H1jet1_i = "<<H1jet1_i<<std::endl;
    // std::cout<<"jetCSV[H1jet1_i] = "<<jetCSV[H1jet1_i]<<std::endl;
    ...
    if (
         ...
         (
           ...
           (tagString=="MMMMbar" && (nTagsM==3 && nTagsMbar==1))                        ||
           (tagString=="LLLL" && nTagsL>=4)                                             ||
           (tagString=="TLTL" && (nTags>=2 && nTagsL>=4))                               ||
           
           (tagString=="AAAA" && nTags0p6>=4)                                           ||
           (tagString=="BBBB" && nTags0p5>=4)                                           ||
           (tagString=="CCCC" && nTags0p4>=4)                                           ||
           (tagString=="DDDD" && nTags0p3>=4)                                           ||
           (tagString=="EEEE" && nTags0p2>=4)                       
         )
       )
    {
      ++nCut6;
      
      // Event weight from b-tag of 4 CMVA>0.71
      if (templ!="Data")
      {
        weightPU=weightPU*btagCMVA_SF;
      }
      ...
      h_RecoGenpT_pT_3_b->Fill(old_jet3pT, (old_jet3pT-jet_genpT[H2jet1_i])/jet_genpT[H2jet1_i], weightPU);
      h_RecoGenpT_pT_4_b->Fill(old_jet4pT, (old_jet4pT-jet_genpT[H2jet2_i])/jet_genpT[H2jet2_i], weightPU);
      
      h_RegGenpT_pT_1_b->Fill(old_jet1pT, (jetpT[H1jet1_i]-jet_genpT[H1jet1_i])/jet_genpT[H1jet1_i], weightPU);
      h_RegGenpT_pT_2_b->Fill(old_jet2pT, (jetpT[H1jet2_i]-jet_genpT[H1jet2_i])/jet_genpT[H1jet2_i], weightPU);
      h_RegGenpT_pT_3_b->Fill(old_jet3pT, (jetpT[H2jet1_i]-jet_genpT[H2jet1_i])/jet_genpT[H2jet1_i], weightPU);
      h_RegGenpT_pT_4_b->Fill(old_jet4pT, (jetpT[H2jet2_i]-jet_genpT[H2jet2_i])/jet_genpT[H2jet2_i], weightPU);
      
      h_RegmGenpT_pT_1_b->Fill(old_jet1pT, (jetpT[H1jet1_i]-jet_genpT[H1jet1_i]), weightPU);
      h_RegmGenpT_pT_2_b->Fill(old_jet2pT, (jetpT[H1jet2_i]-jet_genpT[H1jet2_i]), weightPU);
      h_RegmGenpT_pT_3_b->Fill(old_jet3pT, (jetpT[H2jet1_i]-jet_genpT[H2jet1_i]), weightPU);
      h_RegmGenpT_pT_4_b->Fill(old_jet4pT, (jetpT[H2jet2_i]-jet_genpT[H2jet2_i]), weightPU);
      ...
      // std::cout<<"weightPU_bTag = "<<weightPU_bTag<<std::endl;
      
      // Fill trigger efficiency variables
      /*
      for (unsigned int trig=0; trig<10; ++trig)
      {
        h_trig_afterTag_den->Fill(trig);
        if (triggerFlags[trig] || triggerFlags[0]) h_trig_afterTag_num->Fill(trig);
      }
      */
  ...
  TGraphAsymmErrors *g_trig_afterTag=new TGraphAsymmErrors(h_trig_afterTag_num, h_trig_afterTag_den, "cp"); g_trig_afterTag->SetTitle("Trigger Efficiency after b-tagging; Trigger bit");
  ...
  h_trig_afterTag_den->Write();
  h_trig_afterTag_num->Write();
  g_trig_afterTag->Write();
  tFile2->Write();
  tFile2->Close();
